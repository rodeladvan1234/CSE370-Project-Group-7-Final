...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['semester'])) {
        ...
        if ($firstChar === '1') {
            $dashboard_url = "Faculty_Dashboard.php?user_id=$user_id";
        } elseif ($firstChar === '2') {
            $dashboard_url = "Student_Dashboard.php?user_id=$user_id";
        } elseif ($firstChar === '3') {
            $dashboard_url = "Student_tutor_Dashboard.php?user_id=$user_id";
        } else {
